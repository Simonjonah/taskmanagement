          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <form action="{{ url('admin/updateproduct/'.$edit_product->ref_no) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <select name="subcategory_id" class="form-control select2" style="width: 100%;">
                          <option value="{{ $edit_product->subcategory['id'] }}">{{ $edit_product->subcategory['subcategoryname'] }}</option>
                      ...
                      value="{{ $edit_product->size }}" class="form-control" id="" placeholder=" Enter sizes">
                  </div>
                  @error('size')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                      ...
                      <div class="form-group">
                        ...
                        value="{{ $edit_product->productname }}" class="form-control" id="" placeholder="Products">
                    </div>
                    @error('productname')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="form-group">
                  ...
                  value="{{ $edit_product->discount }}" class="form-control" id="" placeholder="Discount">
              </div>
              @error('discount')
                  <span class="text-danger">{{ $message }}</span>
              @enderror
            ...
            <!-- /.form-group -->
                  ...
                  <div class="form-group">
                    ...
                    value="{{ $edit_product->promo }}" class="form-control" placeholder="promo">
                </div>
                @error('promo')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
                ...
                <label>Select Section</label>
                        <select name="sectionname" class="form-control" style="width: 100%;">
                          <option value="{{ $edit_product->sectionname }}">{{ $edit_product->sectionname }}</option>
            ...
            <!-- /.form-group -->
            <div class="form-group">
              <td><img style="width: auto; height: 30px;" src="{{ URL::asset("/public/../$edit_product->images")}}" alt=""></td>
